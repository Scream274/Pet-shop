    ...
    <div class="container pt-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2"><i
                            class="bi bi-envelope-open text-primary me-2"></i><?= $data["options"]["email"]["value"] ?>
                </p>
                <p class="mb-0"><i
                            class="bi bi-telephone text-primary me-2"></i><?= $data["options"]["phone"]["value"] ?></p>
            </div>
            <div class="col-lg-3 col-md-6">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="d-flex">
                    <a class="btn btn-outline-primary btn-square me-2"
                       href="<?= $data["options"]["twitter"]["value"] ?>"><i class="bi bi-twitter"></i></a>
                    <a class="btn btn-outline-primary btn-square me-2"
                       href="<?= $data["options"]["facebook"]["value"] ?>"><i class="bi bi-facebook"></i></a>
                    <a class="btn btn-outline-primary btn-square me-2"
                       href="<?= $data["options"]["linkedin"]["value"] ?>"><i class="bi bi-linkedin"></i></a>
                    <a class="btn btn-outline-primary btn-square"
                       href="<?= $data["options"]["instagram"]["value"] ?>"><i class="bi bi-instagram"></i></a>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-md-6 text-center text-md-start">
                <p class="mb-md-0">&copy; <a class="text-white" href="/"><?= $data["options"]["title"]["value"] ?></a>.
                    All Rights Reserved.</p>
            </div>
            <div class="col-md-6 text-center text-md-end">
                <p class="mb-0">Designed by <a class="text-white"
                                               href="<?= $data["options"]["designed_by_url"]["value"] ?>">
                        <?= $data["options"]["designed_by_author"]["value"] ?></a></p>
            </div>
        </div>
    </div>
</div>
